        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12 text-right">
              <a class="btn btn-default" href="<%=baseUrl%>/admin/companyServices/new">新增</a>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <table class="table table-strip table-hover">
                ...
                <c:forEach var="companyService" items="${companyServices }" varStatus="status">
                  <tr>
                    <td>${status.index+1}</td>
                    <td>${companyService.name}</td>
                    <td>
                      <a class="btn btn-default" href="<%=baseUrl%>/admin/companyServices/${companyService.id}/edit">编辑</a>
                      <form action="<%=baseUrl%>/admin/companyServices/${companyService.id}/delete" method="POST" style="display: inline;">
