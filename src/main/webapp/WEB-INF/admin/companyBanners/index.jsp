        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12 text-right">
              <a class="btn btn-default" href="<%=baseUrl%>/admin/companyBanners/new">新增</a>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <table class="table table-strip table-hover">
                ...
                <c:forEach var="banner" items="${banners }">
                  <tr>
                    ...
                    <td>${banner.name}</td>
                    <td>
                      <a class="btn btn-default" href="<%=baseUrl%>/admin/companyBanners/${banner.id}/edit">编辑</a>
                      <form action="<%=baseUrl%>/admin/companyBanners/${banner.id}/delete" method="POST" style="display: inline;">
